import { e as defineComponent, u as useConfig, f as useRoute, g as useRouter, h as onMounted, o as openBlock, c as createElementBlock } from "../app.222b9ad1.js";
...
var ct = function() {
}, it = [{ segment: "autocomplete-core", version: "1.7.2" }];
function lt(e2, t2) {
  var n2 = t2;
...
function jo(e2) {
  var t2 = e2.appId, n2 = e2.apiKey, r2 = e2.indexName, o2 = e2.placeholder, c2 = void 0 === o2 ? "Search docs" : o2, i2 = e2.searchParameters, a2 = e2.onClose, u2 = void 0 === a2 ? mr : a2, l2 = e2.transformItems, s2 = void 0 === l2 ? pr : l2, f2 = e2.hitComponent, p2 = void 0 === f2 ? Rn : f2, m2 = e2.resultsFooterComponent, d2 = void 0 === m2 ? function() {
    ...
    return Be.useMemo(function() {
      var r3 = vo(e3, t3);
      return r3.addAlgoliaAgent("docsearch", "3.3.0"), false === /docsearch.js \(.*\)/.test(r3.transporter.userAgent.value) && r3.addAlgoliaAgent("docsearch-react", "3.3.0"), n3(r3);
    }, [e3, t3, n3]);
...
function Co(e2) {
  Ae(Be.createElement(Do, o({}, e2, { transformSearchClient: function(t2) {
    return t2.addAlgoliaAgent("docsearch.js", "3.3.0"), e2.transformSearchClient ? e2.transformSearchClient(t2) : t2;
  } })), function(e3) {
